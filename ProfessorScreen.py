...
class Ui_Professor(object):
    def setupUi(self, Professor):
        ...
        self.dropboxStudents.setGeometry(QtCore.QRect(30, 40, 229, 22))
        self.dropboxStudents.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        ...
        self.dropboxStudents_2 = QtWidgets.QComboBox(self.centralwidget)
        self.dropboxStudents_2.setGeometry(QtCore.QRect(290, 40, 229, 22))
        self.dropboxStudents_2.setObjectName("dropboxStudents_2")
